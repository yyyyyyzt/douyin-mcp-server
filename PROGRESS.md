...
最后更新：项目更名为“自装助手”，完成面向 AI 零基础手机用户的前端重构规划文档；MVP 任务 1~8 已全部落地。
...
MVP（任务 1~8）已全部完成。后续可选增强：
- 前端重构：按 `docs/FRONTEND_REFACTOR_PLAN.md` 分阶段改造为手机端极简体验，底部固定 3 Tab（收集 / 知识库 / 问答）。
